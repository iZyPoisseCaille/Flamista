        <footer>
            <div id="footer">
                <div class="footerLogo">
                    <img src="app/public/css/images/logo_noir.png" alt="Logo de Flamista" />
                </div>
...
<<<<<<< Updated upstream
                            <li><p>|</p></li>
                            <li class="footerLink"><a id="footerLink" href="politiqueconfidentialite.php"><?= utf8_encode("Politique de confidentialit�")?></a></li>
                            <li><p>|</p></li>
=======
                            <li class="footerLinkBar"><p>|</p></li>
                            <li class="footerLink"><a id="footerLink" href="politiqueconfidentialite.php">"Politique de confidentialité </a></li>
                            <li class="footerLinkBar"><p>|</p></li>
>>>>>>> Stashed changes
